...
with st.style.context('st-bmh'):
    ...
    plt.text(2.8, 0.7, r' ⟶ x1 ⟶ x2 ⟶ ',
            fontsize='x-large', bbox=dict(fc="white", ec="steelblue", lw=2))
...
solution1a = m1.solve(tf=50, outputs='A B C sum'.split(),
...
solution4 = m4.solve(tf=100.0, npoints=2000,
                     outputs="x1 x2 x3".split())
solution4b = m4.solve(tf=100.0, npoints=2000, outputs="~",
...
sols = st.Solutions([solution1, solution1a, solution1v,
                    solution3,
