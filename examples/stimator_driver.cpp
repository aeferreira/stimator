...
#include "LSODA/LivermoreSolver.h"
    ...
    ;
    char * filelist [] = {
"C:\\Documents and Settings\\tonho\\My Documents\\stimatordev\\examples\\TSH2a.txt",
"C:\\Documents and Settings\\tonho\\My Documents\\stimatordev\\examples\\TSH2b.txt"
    };
...
double v_glx1 = m_Parameters[0]*variables[1]/(m_Parameters[1] + variables[1]);
double v_glx2 = m_Parameters[2]*variables[0]/(m_Parameters[3] + variables[0]);
derivatives[0] = +1 * v_glx1 -1 * v_glx2 ;
derivatives[1] = -1 * v_glx1 ;
